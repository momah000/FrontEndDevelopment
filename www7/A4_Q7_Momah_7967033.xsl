<?xml version="1.0" ?>
<!-- NOTE: The security parameters of some browsers may prevent this document from working with its associated XML page. However, it has been successfully tested under Firefox 26.0. -->
...
<xsl:template match="/">
	...
	<html>
		<head>
			<title>Assignment 4, Question 7</title>
			<meta charset="utf-8" />
